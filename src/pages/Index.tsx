...
// Tiny module-level cache so repeat renders share one HTTP probe.
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="border-b border-border px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center gap-4">
          ...
          <a href="https://github.com/adjmx/npub.fizx.uk" target="_blank" rel="noopener noreferrer" title="Source on GitHub" aria-label="Source on GitHub" className="shrink-0 text-muted-foreground/60 hover:text-primary transition-colors">
      ...
      <div className="flex-1 max-w-5xl mx-auto w-full px-6 py-10 space-y-8">
        ...
        <div>
          <div className="flex items-center justify-between gap-3 mb-2">
            <AnimatedTitle accent="npub" rest="²" from="#818cf8" to="#c084fc" suffixRgba="rgba(192,132,252,0.55)" />
            <NstartHand />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-muted-foreground">Nostr profile lookup — search relay.fizx.uk by npub or hex pubkey</p>
          </div>
        </div>
        ...
        <section>
          ...
          <div className="flex items-center gap-2 mt-2 flex-wrap">
            ...
            <GraspBadge wsUrl="wss://git.upleb.uk" />
            {relayDetail && (
